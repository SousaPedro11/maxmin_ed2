...
2. Crie ou edite a _Variável de Usuário_ Path adicionando o caminho para \bin do Java JDK (ex: C:\Program Files\Java\jdk1.8.0_144\bin).
...
4. Edite a ___Variável de Sistema___ Path adicionando as linhas: %JAVA_HOME%\bin.
